  ...
  const skillCategories = [
    {
      ...
      level: "8.5/10",
      color: "skill-expert",
      skills: ["Python", "PySpark", "SQL", "AWS Glue", "AWS Lambda", "AWS S3", "ETL/ELT Design", "Git", "Step Functions", "GitHub Copilot", "Claude Code"],
      progress: 85
    },
    {
      title: "Proficient",
      ...
      skills: ["AWS EMR", "CloudFormation", "Athena", "Scala", "Apache Iceberg", "MWAA", "Presto", "Hadoop", "Hive", "REST APIs", "DynamoDB", "Java"],
      progress: 75
    },
    {
      title: "Skilled In",
      ...
      level: "6.5/10",
      color: "skill-skilled",
      skills: ["CI/CD", "Microservices", "MongoDB", "Atlassian Suite", "SNS", "SQS", "ECS", "CloudFront", "Storage Gateway", "Flask", "Bitbucket", "Bamboo", "Jira", "Data Modeling", "Data Lake"],
      progress: 65
    }
  ];
